 # src/classifier/train_with_basic_aug.py
...
def train_with_basic_aug():
    ...
    # Output dirs
    # ====================
    exp_name = log_cfg["logging"]["experiment_aug"]
    ...
    # Dataset
    # ====================
    images_dir = exp_cfg["dataset"]["processed"]["root"]
    ...
    train_set = SkinLesionDataset(
        ...
        csv_file=train_csv,
        mode="train",   # class-aware augmentation inside
        use_class_aug=True,
    )
